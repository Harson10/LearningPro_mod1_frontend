  ...
  return (
    <div className="box-border w-screen h-screen">
      ...
      <div className="enTete flex relative w-full h-[50px] lg:h-[75px] z-20 shadow-md shadow-gray-700">
        ...
        <Link to="/connexion">
          <button className="bouton_connexion_acceuil absolute px-0 w-[60px] top-[9px] right-[10px] h-[35px] lg:px-8 lg:w-[250px] lg:top-[12.25px] lg:right-[30px] lg:h-[50px] rounded-[30px] text-white font-bold shadow-md border-2 border-white flex items-center hover:bg-green-700">
            <div className="pl-4 hidden lg:block">Se connecter</div>
            <div className="p-4 pr-4 text-2xl lg:text-base"><FaSignInAlt /></div>
          </button>
        </Link>
      </div>
      ...
      <div className="absolute top-0 bg-opacity-60 bg-gray-500 w-full h-full z-0">
        ...
        />
        <div className="nom_ets_ralaivao absolute top-[72%] left-[5%] w-[335px] p-2 pr-4 text-[12.5px] lg:top-[74%] lg:left-[18%] lg:w-[480px] lg:p-4 lg:pr-4 lg:text-auto text-white text-right lg:text-center justify-center items-center border border-white rounded-br-[30px] shadow-md">
